...
import PatientPrescriptionDetailPage from "@/pages/patient/prescriptions/PatientPrescriptionDetailPage"
...
export const patientRoutes = {
  ...
  children: [
    ...
    { path: "prescriptions/:id", element: <PatientPrescriptionDetailPage /> },
