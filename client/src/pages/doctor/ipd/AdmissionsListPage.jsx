...
export default function DoctorAdmissionsListPage() {
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex justify-end">
            <Button variant="secondary" size="sm" as={Link} to={`${DOCTOR_ROUTES.IPD}/${row.original.id}`}>
              View
            </Button>
          </div>
        )
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-slate-600">Patients admitted under your care.</p>
      </div>
      <Card className="p-4">
