...
export default function NurseAdmissionsListPage() {
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex justify-end">
            <Button variant="secondary" size="sm" as={Link} to={`/nurse/ipd/${row.original.id}/notes`}>
              Notes
            </Button>
          </div>
        )
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-lg font-semibold text-slate-900">IPD Admissions</h1>
          <p className="text-sm text-slate-600">Active admissions and nursing notes.</p>
        </div>
        <Button variant="secondary" as={Link} to="/nurse">
          Back
        </Button>
      </div>
